...
/**
 * 重写swagger的项目路径匹配方法
 * <p>该方法匹配 com.github.geng.**.controller | com.github.geng.* 写法</p>
 * @author geng
 */
public class SwaggerSelectors {
    ...
    public static void main(String[] args) {
        // String className = "com.github.geng.admin.business.controller";
        ...
        // System.out.println("com.github.geng.**.controller".contains("**"));
    }
}
